package com.psi.content.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.psi.content.dao.ContentMapper;
import com.psi.content.pojo.Content;
import com.psi.content.service.ContentService;
...
public class ContentServiceImpl extends ServiceImpl<ContentMapper, Content> implements ContentService {
    ...
    public List<Content> findByCategoryId(Long id) {
        ...
        content.setCategoryId(id);//设置广告分类id
        content.setStatus("1");//设置广告状态为1，可用
        //构建查询条件
        QueryWrapper<Content> queryWrapper = this.createQueryWrapper(content);
        //根据设置字段升序排序
        queryWrapper.orderByAsc("sort_order");
        List<Content> list = this.list(queryWrapper);
        return list;
    }
}

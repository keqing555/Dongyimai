...
public class AddressController {
    ...
    public Result<List<Address>> findAddressByUid() {
        String user_name = tokenDecode.getUserInfo().get("user_name");
        List<Address> addressList = addressService.findAddressByUid(user_name);
        return new Result<>(true, StatusCode.OK, "查询收货地址成功", addressList);
    }
}

...
//    }
    @ApiOperation(value = "添加Specification", notes = "添加Specification方法详情", tags = {"SpecificationController", "规格控制器"})
    @PostMapping
    public Result add(@RequestBody @ApiParam(name = "SpecEntity组合实体", value = "传入JSON数据") SpecEntity specEntity) {
        try {
